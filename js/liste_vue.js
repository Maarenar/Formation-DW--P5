...
let homeTitle = "<h2>Caméras vintage</h2>";
...
const appareilQuatre = new Appareil(4,"Minolta XG 7 appareil",780,"Il s'agit d'un appareil photo entièrement manuel. Ces caméras sont vraiment amusant à tirer et facile à utiliser. Le corps de la caméra est en bon état, il ya quelques sings d'utilisation sur le corps, le corps est en parfait état de fonctionnement, les feux d'obturateur à toutes les vitesses, le viseur est propre.L'appareil photo est livré avec un objectif Minolta 50mm Prime. Il produit de magnifiques images nettes de rasoir.","./img/vcam_4.jpg",0);
const AppareilCinq = new Appareil(5,"Olympus OM-10 SLr 35MM",250,"Reflex 35mm vintage, Lens est un Olympus OM-System Zuiko Auto-S 1:1,8 50mm.Lentille supplémentaire - J.C. Penny 55-135mm Optique multi-enduite 1:2.8f -135mm, Filtre UV - Super Albinar 49MM, Doté d’une exposition automatique (AE) se base sur le compteur de lumière directe TTL.","./img/vcam_5.jpg",0);
